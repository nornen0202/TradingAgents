...
PC·모바일 전략 화면은 종목 검색·정렬, 선택 조건 URL 복원, 데이터 갱신 재시도를 지원합니다. [UI·UX·성능·운영 종합 검토와 외부 사례 비교](Docs/product_experience_audit_20260922_ko.md)를 참고하세요.
...
일일 분석은 [보유 종목 필수 포함·한국/미국 각각 최대 30개 자동 선정](Docs/adaptive_analysis_universe_ko.md)을 적용합니다. 고정 관심 목록과 이전 분석, 최신 시장 조사를 비교해 대상을 갱신하며, 종목별 심층 분석 수준은 유지합니다.
