> 이전 마이그레이션 기록입니다. 2026-09-11부터 [품질 우선 정책과 기준 프로젝트 개선 내역](baseline_upgrade_20260911_ko.md)이 우선합니다. 현재 기본값은 전체 역할 Sol, deep/judge xhigh, quick/writer high, output medium이며 자동 모델 강등은 꺼져 있습니다. 아래 비용 우선 표와 롤백 예시는 과거 설정입니다.
