...
| 의존성 보안 | Soup Sieve 2.8.4의 정규식 처리 지연 취약점 2건(저장소 경고 #67/#68) | [2.9 공식 수정](https://github.com/facelessuser/soupsieve/releases/tag/2.9)을 잠금 파일에 반영. 기존 #282의 3줄 수정과 동일하며 별도 로컬 경로에 설치해 전체 테스트 재검증 |
