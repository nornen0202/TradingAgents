...
_DOC_ENV_MAP = {
    ...
    "ALPACA_ENDPOINT": "Alpaca trading endpoint",
    ...
    "DALOOPA_API_KEY": "Daloopa API Key",
    "DATASITE_API_KEY": "Datasite API Key",
    "DATASITE_CLIENT_ID": "Datasite Client ID",
    "FACTSET_API_KEY": "FactSet API Key",
    "FACTSET_PASSWORD": "FactSet Password",
    "FACTSET_USERNAME": "FactSet Username",
    "HEBBIA_API_KEY": "Hebbia API Key",
    "LSEG_API_KEY": "LSEG API Key",
    "LSEG_APP_KEY": "LSEG App Key",
    "MOODYS_API_KEY": "Moody's API Key",
    ...
    "SPGLOBAL_API_KEY": "S&P Global API Key",
    "SP_GLOBAL_API_KEY": "S&P Global API Key",
    "THIRD_BRIDGE_API_KEY": "Third Bridge API Key",
}
...
_ENV_ALIASES = {
    ...
    "KIS_DEMO_PRODUCT_CODE": ("KIS_DEMO_PRODUCT_CODE", "KIS_VTS_PRODUCT_CODE"),
    "ALPHA_VANTAGE_API_KEY": ("ALPHA_VANTAGE_API_KEY", "ALPHA_VANTAGE_KEY"),
    "ALPACA_API_KEY_ID": ("ALPACA_API_KEY_ID", "APCA_API_KEY_ID", "ALPACA_KEY_ID"),
    "ALPACA_DATA_FEED": ("ALPACA_DATA_FEED", "APCA_DATA_FEED"),
    "ALPACA_ENDPOINT": ("ALPACA_ENDPOINT", "APCA_API_BASE_URL"),
    "ALPACA_SECRET_KEY": ("ALPACA_SECRET_KEY", "APCA_API_SECRET_KEY", "ALPACA_API_SECRET"),
    ...
    "MASSIVE_API_KEY": ("MASSIVE_API_KEY", "POLYGON_API_KEY", "POLY_API_KEY"),
    "DALOOPA_API_KEY": ("DALOOPA_API_KEY", "DALOOPA_KEY"),
    "DATASITE_API_KEY": ("DATASITE_API_KEY", "DATASITE_KEY"),
    "DATASITE_CLIENT_ID": ("DATASITE_CLIENT_ID",),
    "FACTSET_API_KEY": ("FACTSET_API_KEY", "FACTSET_KEY"),
    "FACTSET_PASSWORD": ("FACTSET_PASSWORD",),
    "FACTSET_USERNAME": ("FACTSET_USERNAME",),
    "HEBBIA_API_KEY": ("HEBBIA_API_KEY", "HEBBIA_KEY"),
    "LSEG_API_KEY": ("LSEG_API_KEY", "REFINITIV_API_KEY"),
    "LSEG_APP_KEY": ("LSEG_APP_KEY", "REFINITIV_APP_KEY"),
    "MOODYS_API_KEY": ("MOODYS_API_KEY", "MOODYS_KEY"),
    "MORNINGSTAR_API_KEY": ("MORNINGSTAR_API_KEY", "MORNINGSTAR_KEY"),
    ...
    "PITCHBOOK_API_KEY": ("PITCHBOOK_API_KEY", "PITCHBOOK_KEY"),
    "QUARTR_API_KEY": ("QUARTR_API_KEY", "QUARTR_KEY"),
    "SPGLOBAL_API_KEY": ("SPGLOBAL_API_KEY", "SP_GLOBAL_API_KEY", "SNP_GLOBAL_API_KEY", "SPGMI_API_KEY"),
    "SP_GLOBAL_API_KEY": ("SP_GLOBAL_API_KEY", "SPGLOBAL_API_KEY", "SNP_GLOBAL_API_KEY", "SPGMI_API_KEY"),
    "THIRD_BRIDGE_API_KEY": ("THIRD_BRIDGE_API_KEY", "THIRDBRIDGE_API_KEY"),
}
