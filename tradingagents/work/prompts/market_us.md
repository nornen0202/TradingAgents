...
6. feed 지연·비통합 시세, provider 상태 제한, 과도한 spread, LULD/news halt 미확인은 `CONDITIONAL`로 낮춘다. `BLOCKED_STALE` 또는 `MISSING`의 BUY/SELL/REDUCE 의도는 “직전 위험 신호—실시간 재확인 최우선”으로만 표시한다.
