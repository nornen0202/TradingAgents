...
def _writer_prompt_header(language: str) -> str:
    return (
        ...
        "Explain necessary finance terms in plain language on first use. Distinguish a conditional watchlist plan from permission to buy now. "
        "Never turn model confidence into a probability of profit, invent prices/targets, or claim returns are guaranteed. "
        "Preserve source dates, data gaps and invalidation conditions.\n"
